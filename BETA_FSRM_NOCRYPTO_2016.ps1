...
# Set it to 0 or another value different than 0 will cause de script to keep Passive Shares generated by this script from FSRM
$delpassive = "1"
#############################################
...
# Keeping list to compare next time with new one 
